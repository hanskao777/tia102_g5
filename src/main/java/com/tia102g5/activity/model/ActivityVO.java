...
public class ActivityVO implements Serializable {
	...
	public ActivityVO(Integer activityID, Integer partnerID, Integer venueID, Integer venueRentalID,
			...
			Timestamp activityPostTime, String activityTag, Integer activityStatus, Integer ticketSetStatus,
			Timestamp sellTime) {
		super();
	...
	public Timestamp getActivityPostTime() {
		return activityPostTime;
	}

	public void setActivityPostTime(Timestamp activityPostTime) {
		this.activityPostTime = activityPostTime;
	}

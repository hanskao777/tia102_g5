...
public class ArticleImgDAOImpl implements ArticleImgDAO {
	...
	@Override
	public int insert(ArticleImg entity) {
		// 回傳給 service 剛新增成功的自增主鍵值
		return (Integer) getSession().save(entity);
	}

	@Override
	public int update(ArticleImg entity) {
		try {
	...
	public int delete(Integer id) {
		ArticleImg articleImg = getSession().get(ArticleImg.class, id);
		if (articleImg != null) {
	...
	@Override
	public ArticleImg getById(Integer id) {
		return getSession().get(ArticleImg.class, id);
	}

	@Override
	public List<ArticleImg> getAll() {
		return getSession().createQuery("from ArticleImg", ArticleImg.class).list();

...
CREATE TABLE GeneralMember(
    ...
    memberCreateTime           DATETIME      NOT NULL 
		                                     DEFAULT CURRENT_TIMESTAMP
		                                     NOT NULL          COMMENT "帳號建立時間",
...
CREATE TABLE VenueArea(
	...
	areaName                    VARCHAR(255) NOT NULL          COMMENT "區域代號 如NA, NB, NC, MA, MB, MC, SA, SB, SC",
...
CREATE TABLE ActivityTimeSlot(
    ...
    activityID                   INT           NOT NULL           COMMENT "活動ID",
    acitivityTimeSlotDate        DATE          NOT NULL           COMMENT "日期",
